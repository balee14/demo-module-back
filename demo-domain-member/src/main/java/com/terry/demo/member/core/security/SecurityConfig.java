...
import com.terry.demo.core.enums.PfEnvTypeEnum;
import com.terry.demo.core.util.PfPropertyUtil;
import com.terry.demo.member.core.jwt.JwtAuthenticationFilter;
import com.terry.demo.member.core.jwt.JwtExceptionFilter;
import com.terry.demo.member.core.jwt.JwtTokenProvider;
import com.terry.demo.member.member.service.CustomUserDetailsService;
...
//    public static final String IP_CHECK_PATH_PATTERN = IP_CHECK_PATH_PREFIX + "/**";
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        ...
        //  local여부 확인
        if(PfEnvTypeEnum.isJwtType(PfPropertyUtil.getProperty("spring.profiles.active"))) {

            httpSecurity.authorizeHttpRequests((authorize) -> authorize
                .requestMatchers("/api/admin/v1/sign/in").permitAll() // 로그인 패스
            ...
            // local이면 개발 편의성을 인증 확인 안하고 패스 시킨다.
            httpSecurity.authorizeHttpRequests((authorize) -> authorize
        ...
        httpSecurity.addFilterBefore(new JwtAuthenticationFilter(jwtTokenProvider, customUserDetailsService, memberTokenRepository), UsernamePasswordAuthenticationFilter.class)
