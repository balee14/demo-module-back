    ...
    public WebSecurityCustomizer webSecurityCustomizer() {
        return web -> {
            web.ignoring()
                ...
                .requestMatchers("/api/admin/v1/sign/in")
                .requestMatchers("/api/admin/v1/member")
...
//        }
        ...
        try {
            ...
            if(requestURI.equals("/api/admin/v1/sign/accessToken") || requestURI.equals("/api/user/v1/sign/accessToken")) {

                // accessToken 오류 체크 시작
                ...
                if (!ObjectUtils.isEmpty(refreshToken)) {
                    ...
                    memberTokenRepository.memberTokenErrorRefreshToken(refreshToken);
                    throw new JwtException(CommonCustomType.CLIENT_ERROR_401_REFRESH_TOKEN_20.name());
                }
