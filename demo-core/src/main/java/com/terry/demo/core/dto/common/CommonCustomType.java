...
public enum CommonCustomType {
    ...
    // 메뉴
    SUCCESSFUL_200_10(CommonResponseEntityType.OK.getResponseCode(), "10","메뉴가 없습니다."),
    // 메뉴 옵션 카테고리
    SUCCESSFUL_200_20(CommonResponseEntityType.OK.getResponseCode(), "20","메뉴 옵션 카테고리가 없습니다."),
    // 메뉴 옵션
    SUCCESSFUL_200_30(CommonResponseEntityType.OK.getResponseCode(), "30","메뉴 옵션이 없습니다."),
    // 메뉴 카테고리
    SUCCESSFUL_200_40(CommonResponseEntityType.OK.getResponseCode(), "40","메뉴 카테고리가 없습니다."),

    // 테스트
    SUCCESSFUL_200_90(CommonResponseEntityType.OK.getResponseCode(), "90","테스트가 없습니다."),
    ...
    CLIENT_ERROR_401_31(CommonResponseEntityType.UNAUTHORIZED.getResponseCode(),"31","PfMemberUtil.getUserId"),
    CLIENT_ERROR_401_32(CommonResponseEntityType.UNAUTHORIZED.getResponseCode(),"32","PfMemberUtil.getIdEmail"),
    CLIENT_ERROR_401_33(CommonResponseEntityType.UNAUTHORIZED.getResponseCode(),"33","PfMemberUtil.getUserName"),
